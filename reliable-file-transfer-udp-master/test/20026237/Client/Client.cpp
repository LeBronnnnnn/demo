...
class UDPClient
{
	...
	void setServerAddress(const char *ip,int portNo);
 ...
 */
void UDPClient::setServerAddress(const char *ip,int portNo)
{
...
int main(int noOfArguments,char *argumentList[])
{
	...
	client.setServerAddress(argumentList[1],atoi(argumentList[2]));//ip+port+file+window
